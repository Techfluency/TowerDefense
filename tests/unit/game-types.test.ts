...
describe('GAME_EVENTS', () => {
  ...
  it('should have exactly 21 events defined', () => {
    /* 12 original + 6 BOLT-001 + 1 BOLT-002 + 1 BOLT-003 (ENEMY_SPAWNED) + 1 BOLT-007 (TOWER_REPAIRED). */
    expect(Object.keys(GAME_EVENTS).length).toBe(21);
  });
